...
The VPS never compiles anything — `next build` is memory-hungry and, on 2 shared vCPUs, would crawl even with 8 GB to play with. GitHub Actions builds, GHCR stores, Dokku pulls. Deploys take seconds and a broken build never reaches production.
